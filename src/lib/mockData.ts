...
export const testimonials = [
  {
    ...
    text: 'SportsDesk completely changed how we manage our district-level cricket tournaments. The live scoring and bracket system is incredible.',
    avatar: '🏏',
    rating: 5,
  },
  {
    ...
    text: 'Managing 12 teams was always a nightmare. With SportsDesk, everything from registrations to fixtures is seamless.',
    avatar: '🤼',
    rating: 5,
  },
  {
